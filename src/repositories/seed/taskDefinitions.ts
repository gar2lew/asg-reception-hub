...
export const SEED_TASK_DEFINITIONS: TaskDefinition[] = [
  {
    ...
    recurrence: 'daily', assignedStaffIds: ['reception-001'], required: true, priority: 'high',
  ...
  },
  {
    ...
    recurrence: 'daily', assignedStaffIds: ['reception-001'], required: true, priority: 'normal',
  ...
  },
  {
    ...
    recurrence: 'daily', assignedStaffIds: ['reception-001'], required: false, priority: 'normal',
  ...
  },
  {
    ...
    recurrence: 'daily', assignedStaffIds: ['reception-001'], required: false, priority: 'low',
  ...
  },
  {
    ...
    recurrence: 'weekly', assignedStaffIds: ['reception-001'], required: false, priority: 'normal',
  ...
  },
  {
    ...
    recurrence: 'monthly', assignedStaffIds: ['reception-001'], required: true, priority: 'normal',
